...
//@route GET /api/products/all
//@access Public
const getAllRetailerProductsPeriod = asyncHandler(async (req,res)=>{
  res.header("Access-Control-Allow-Origin","*")

  console.log("WE ARE IN  RETAILER PRODUCT  PERIOD CONTROLLER")
...
export {addNewRetailerProduct,getProducts, getProductById,deleteProduct, createProduct,addProduce,updateProduce, updateProduct, updateProductStockCount, createProductReview ,getTopProducts,getAllRetailerProducts,getAllRetailerProductsPeriod}
